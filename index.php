...
<body>
  ...
  <main>
    <section class="form-container">
      <h2>Student Login</h2>
      <?php if ($error): ?>
        <p style="color:#e74c3c; text-align:center; margin-top:10px; font-weight:600;"><?= htmlspecialchars($error) ?></p>
      <?php endif; ?>
      <?php if (isset($_GET['registered'])): ?>
        <p style="color:#27ae60; text-align:center; margin-top:10px; font-weight:600;">Registration successful! Please log in.</p>
      <?php endif; ?>
      ...
      <p style="text-align:center; margin-top:12px; font-size:0.9rem;">
        No account yet? <a href="Register.php" style="color:#1a5276; font-weight:600;">Register here</a>
      </p>
    </section>
  </main>
</body>
